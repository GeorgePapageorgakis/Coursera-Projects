...
def mystery3(input_val):
    """ 
    Function whose loops update global counter
	This is a slowly growing exp function (1.1 ** index)    
    """
    global counter
    for index in range(input_val):
...
def build_plot(plot_size, plot_function, plot_type):
    """
    ...
    for input_val in range(2, plot_size):
        ...
        # For plot_type STANDARD or LOGLOG
        if plot_type:
...
simpleplot.plot_lines("Iteration counts", 600, 600, "input", "counter", [plot1, plot2, plot3])
